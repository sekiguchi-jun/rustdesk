...
def build_flutter_dmg(version, features):
    ...
    _apps = _glob.glob('./build/macos/Build/Products/Release/*.app')
    _app = _apps[0] if _apps else './build/macos/Build/Products/Release/RustDesk.app'
    system2('cp -rf ../target/release/service "%s/Contents/MacOS/"' % _app)
    '''
    system2(
